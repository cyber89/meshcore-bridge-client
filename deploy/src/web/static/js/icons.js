/**
 * MeshCore UI - Lucide Vector Icons Library (100% Offline, Zero CDN dependency).
 * Provee iconos SVG vectoriales nítidos y ultra-ligeros para toda la interfaz.
 */
...
const LUCIDE_ICONS = {
  ...
  'radio-tower': '<path d="M4.9 16.1C1 12.2 1 5.8 4.9 1.9"/><path d="M7.8 13.2c-2.3-2.3-2.3-6.1 0-8.5"/><circle cx="12" cy="9" r="2"/><path d="M16.2 4.8c2.3 2.3 2.3 6.1 0 8.5"/><path d="M19.1 1.9C23 5.8 23 12.1 19.1 16"/><path d="M9 22l3-7 3 7"/><path d="M8 22h8"/>',
  'shield': '<path d="M20 13c0 5-8 9-8 9s-8-4-8-9V5l8-3 8 3z"/>',
  ...
  'broom': '<path d="m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21"/><path d="M22 21H7"/><path d="m5 11 9 9"/>',
  'repeat': '<path d="m17 2 4 4-4 4"/><path d="M3 11v-1a4 4 0 0 1 4-4h14"/><path d="m7 22-4-4 4-4"/><path d="M21 13v1a4 4 0 0 1-4 4H3"/>',
  'star': '<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>',
  'info': '<circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/>',
  'filter': '<polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/>',
  'layers': '<polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/>',
  'radar': '<path d="M19.07 4.93A10 10 0 0 0 4.93 19.07"/><path d="M16.24 7.76A6 6 0 0 0 7.76 16.24"/><path d="m12 12 4-4"/><circle cx="12" cy="12" r="10"/><path d="M12 2v20"/><path d="M2 12h20"/>',
  ...
  'shield-alert': '<path d="M20 13c0 5-8 9-8 9s-8-4-8-9V5l8-3 8 3z"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/>',
...
function getLucideIcon(name, extraClass = '', size = 18) {
  const content = LUCIDE_ICONS[name] || LUCIDE_ICONS['activity'];
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide-icon lucide-${name} ${extraClass}">${content}</svg>`;
}
