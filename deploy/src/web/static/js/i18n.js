...
(function () {
  ...
  const DICT = {
    es: {
      ...
      'chat.yesterday':            'Ayer',
      'chat.date_today':           'HOY',
      'chat.date_yesterday':       'AYER',
      'chat.delivered':            'Entregado',
      'chat.sent':                 'Enviado',
      'chat.queued':               'En cola',
      'chat.cleared':              'Historial de chat limpiado',
      'chat.write_below':          'Escribe un mensaje en el campo inferior para comenzar',
      'chat.no_messages':          'No hay mensajes en esta conversación',
      'chat.gps_shared':           'Ubicación GPS Compartida',
      ...
      'chat.share_contact':        'Compartir Contacto',
      ...
      'chat.last_seen_mins':       'Últ. vez hace {n} min',
    ...
    en: {
      ...
      'chat.write_below':          'Type a message below to begin',
      'chat.no_messages':          'No messages in this conversation',
      'chat.gps_shared':           'Shared GPS Location',
      'chat.view_map':             'View on Map',
      'chat.sound_on':             'Chat sound alerts enabled',
      'chat.sound_off':            'Chat sound alerts disabled',
      'chat.share_contact':        'Share Contact',
      ...
      'chat.last_seen_mins':       'Last seen {n} min ago',
  ...
  const DOM_MAP = [
    ...
    { s: '#btnHeaderAddContact',         k: 'contacts.add', last: true },
    { s: '#btnHeaderImportContact',      k: 'chat.import_channel_title', a: 'title' },
    { s: '.contacts-filter-pills .filter-pill[data-contact-filter="all"]', k: 'contacts.filter_all', last: true },
    { s: '.contacts-filter-pills .filter-pill[data-contact-filter="favorites"]', k: 'contacts.filter_favorites', last: true },
    { s: '.contacts-filter-pills .filter-pill[data-contact-filter="online"]', k: 'contacts.filter_online', last: true },
    ...
    { s: '#btnCenterLocalNode',                       k: 'map.center_local', a: 'title' },
    ...
    { s: '#cardTopActive .analytics-card-header h3', k: 'analytics.top_active', last: true },
    { s: '#cardTopActive .analytics-card-header p',  k: 'analytics.top_active_sub' },
    { s: '#cardSignal .analytics-card-header h3',    k: 'analytics.signal', last: true },
    { s: '#cardSignal .analytics-card-header p',     k: 'analytics.signal_sub' },
    { s: '#cardRepeaters .analytics-card-header h3', k: 'analytics.repeaters', last: true },
    { s: '#cardRepeaters .analytics-card-header p',  k: 'analytics.repeaters_sub' },
    { s: '#cardBridge .analytics-card-header h3',    k: 'analytics.bridge', last: true },
    { s: '#cardBridge .analytics-card-header p',     k: 'analytics.bridge_sub' },
    ...
    { s: '#qrModalTitle, #qrShareTitle', k: 'qr.title', last: true },
    { s: '#qrShareDesc',                 k: 'qr.scan_hint', last: true },
    { s: 'label[for="qrUriDisplay"], label[for="qrShareUri"]', k: 'qr.uri_label' },
