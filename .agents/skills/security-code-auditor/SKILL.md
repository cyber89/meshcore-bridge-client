...
1. **Validación de Esquemas e Inyección**: Verificar que todas las entradas JSON y parámetros de la API REST se validen y saniticen estrictamente.
...
4. **Denegación de Servicio (DoS)**: Verificar límites de tamaño en cargas útiles JSON, protección contra floods de tramas y colas con tamaño acotado (`maxlen` en deques y buffers de memoria).
